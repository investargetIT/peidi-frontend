...
export default {
  data() {
    return {
      ...
      dailyBarChartStartDate: null,
      dailyBarChartEndDate: null,
      // columns: [
  ...
  methods: {
        ...
        toolbox: {
          feature: {
            myFeature: {
              ...
              onclick: function () {
                nuxt.displayEchartsGoodsBar = false;
                nuxt.displayEchartsGoodsBarDaily = true;
                nuxt.getSPUShopSalesDailyData(spu, nuxt.dailyBarChartStartDate, nuxt.dailyBarChartEndDate);
              }
            }
          }
        },
    ...
    drawSPUDailySalesBarChart(data, spu, startDate, endDate) {
          ...
          feature: {
            myFeature: {
              ...
              onclick: function () {
                ...
                nuxt.displayEchartsGoodsBarDaily = false;
                nuxt.displaySPUGoals = false;
                nuxt.dailyBarChartStartDate = null;
                nuxt.dailyBarChartEndDate = null;
                nuxt.displayEchartsGoodsLine = true;
                nuxt.getAndDrawSPUSalesData();
              }
            }
      ...
      myChart.on('click', function (params) {
        console.log(params);
        nuxt.dailyBarChartStartDate = startDate;
        nuxt.dailyBarChartEndDate = endDate;
        nuxt.displayEchartsGoodsBar = true;
        nuxt.displayEchartsGoodsBarDaily = false;
